...
export const FALLBACK_SITES: CandidateSite[] = [
  {
    ...
    why_this_site: [
      "Liebig capacity can absorb up to 250 additional residents.",
      "Located outside active Wayanad debris flow zones in current GIS layer.",
      "Short transit corridor of 12 km from highland fringe.",
    ],
    why_not_this_site: [
      "Strictly constrained by school infrastructure bottleneck at 250 residents.",
    ...
    primary_blockers: [
      "Primary school absorption limit (250 residents max)",
    ...
    land_administrative_screening: {
      ...
      land_acquisition_feasibility: "NOT ASSESSED",
      field_verification: "REQUIRED",
      note: "Prototype estimate — cadastral survey required by District Revenue Authority before legal allotment."
    },
    ...
    landTenure: {
      ...
      surveyNumber: "Cadastral Survey Pending",
      encumbranceStatus: "Gram Sabha Consent Pending",
      litigationRisk: "Low",
      clearanceTimelineMonths: 3,
  ...
  },
  {
    ...
    why_this_site: [
      "Large effective capacity: absorbs up to 550 residents across all dimensions.",
      "Located in stable midland terrain outside coastal surge zone.",
      "Road transit link is 26 km via state highway.",
    ],
    why_not_this_site: [
      "Constrained by schools capacity bottleneck at 550 residents.",
      "Government poramboke classification requires formal de-reservation and revenue gazette.",
      "Livelihood transition from coastal fishing to midland services is NOT ASSESSED.",
    ],
    primary_blockers: [
      "School capacity bottleneck (550 residents)",
      "Cadastral title and environmental zoning unverified",
    ],
    land_administrative_screening: {
      land_ownership: "UNKNOWN",
      legal_encumbrance: "UNKNOWN",
      ...
      land_acquisition_feasibility: "NOT ASSESSED",
      field_verification: "REQUIRED",
      note: "Requires ground cadastral demarcation by Revenue Department."
    },
    livelihood_continuity: {
      status: "NOT ASSESSED",
      employment_access: "NOT ASSESSED",
      ...
      market_access: "NOT ASSESSED",
      field_validation: "FIELD SOCIOECONOMIC VALIDATION REQUIRED",
      note: "Livelihood continuity requires local socioeconomic and field validation."
    },
    landTenure: {
  ...
  },
  {
    ...
    why_this_site: [
      "Outside active Teesta and Sundarbans storm surge runouts.",
      "Graded elevated plain terrain.",
    ],
    why_not_this_site: [
      "Severe healthcare bottleneck: only 150 residents supportable.",
      "Transit distance of 41 km exceeds 35 km operational target.",
      "Private land requires complex acquisition under LARR Act, 2013.",
    ],
    primary_blockers: [
      "Healthcare capacity bottleneck (150 residents max)",
      "Long transit distance (41 km)",
      "Land acquisition feasibility NOT ASSESSED",
    ],
    land_administrative_screening: {
      land_ownership: "UNKNOWN",
      legal_encumbrance: "UNKNOWN",
      ...
      land_acquisition_feasibility: "NOT ASSESSED",
      field_verification: "REQUIRED",
      note: "Private agricultural land requires formal LARR 2013 social impact assessment."
    },
    livelihood_continuity: {
      status: "NOT ASSESSED",
      employment_access: "NOT ASSESSED",
  ...
  },
  {
    ...
    why_this_site: [
      "Moderate distance: 18 km transit link.",
      "Absorbs up to 300 residents before schools bottleneck.",
    ],
    why_not_this_site: [
      "Proximity to forest tracts requires environmental and Forest Conservation Act review.",
      "Cadastral boundaries and encumbrances are UNKNOWN.",
      "Livelihood continuity has NOT BEEN ASSESSED.",
    ],
    primary_blockers: [
      "Environmental & forest clearance status UNKNOWN",
      "Cadastral land verification REQUIRED",
    ],
    land_administrative_screening: {
      land_ownership: "UNKNOWN",
      legal_encumbrance: "UNKNOWN",
      ...
      land_acquisition_feasibility: "NOT ASSESSED",
      field_verification: "REQUIRED",
      note: "Potential forest fringe; requires MoEFCC / DFO clearance audit."
    },
    livelihood_continuity: {
      status: "NOT ASSESSED",
      employment_access: "NOT ASSESSED",
  ...
  },
  {
    ...
    why_this_site: [
      "High carrying capacity: can accommodate up to 600 residents.",
      "Located on stable terrace bed away from active Joshimath subsidence zone.",
      "Transit distance: 24 km via NH-58 link.",
    ],
    why_not_this_site: [
      "Constrained by schools infrastructure bottleneck at 600 residents.",
      "Cadastral land boundaries and encumbrances are UNKNOWN.",
      "Livelihood disruption for hill farmers and pilgrims is NOT ASSESSED.",
    ],
    primary_blockers: [
      "School capacity bottleneck (600 residents)",
      "Cadastral title and geotechnical core drilling REQUIRED",
    ],
    land_administrative_screening: {
      land_ownership: "UNKNOWN",
      legal_encumbrance: "UNKNOWN",
      ...
      land_acquisition_feasibility: "NOT ASSESSED",
      field_verification: "REQUIRED",
      note: "Hill terrace requires geotechnical load-bearing survey before construction."
    },
    livelihood_continuity: {
      status: "NOT ASSESSED",
      employment_access: "NOT ASSESSED",
  ...
  },
  {
    ...
    why_this_site: [
      "Largest carrying capacity in pilot dataset: supports up to 750 residents.",
      "High ground situated outside active Brahmaputra riverine floodway.",
      "Transit distance: 32 km from Majuli ferry terminal.",
    ],
    why_not_this_site: [
      "Constrained by schools infrastructure bottleneck at 750 residents.",
      "River transit and ferry reliability in monsoon season introduces logistical vulnerability.",
      "Livelihood continuity for island agro-fishing community is NOT ASSESSED.",
    ],
    primary_blockers: [
      "School capacity bottleneck (750 residents)",
      "River transit vulnerability during peak flood surge",
      "Cadastral land verification REQUIRED",
    ],
    land_administrative_screening: {
      land_ownership: "UNKNOWN",
      ...
      land_acquisition_feasibility: "NOT ASSESSED",
      field_verification: "REQUIRED",
      note: "Vested poramboke land; requires formal de-reservation by Circle Officer (Revenue)."
    },
    livelihood_continuity: {
      status: "NOT ASSESSED",
      employment_access: "NOT ASSESSED",
...
export const FALLBACK_SOURCES: DataSource[] = [
  ...
  { name: "India Meteorological Department (IMD)", covers: "Rainfall intensity, cyclone tracking", updated: "Demonstration Standards", confidence: "High" },
